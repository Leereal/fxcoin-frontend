...
<div>
                        ...
                        <div class="col-sm-6 col-md-6 col-lg-3">
                            ...
                            <div class="full">
                                <ul class="menu_footer">
                                    ...
                                    <li><router-link to="/register"> >Get Registered Now</router-link></li>
                                    <li><router-link to="/login"> >Already a Member</router-link></li>                                    
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-3">
    ...
    <div class="footer_bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="crp">© Copyrights {{ $moment().year() }}</p>
                </div>
            </div>
        </div>
    </div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5f4203e91e7ade5df443253e/default';
s1.charset='UTF-8';
