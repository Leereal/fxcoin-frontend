  ...
  <div class="container-fluid">
    ...
    <div class="row jumbotron mb-3">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
        <img src="../assets/front/images/img3.png" alt="" class="img-fluid" />
        <router-link to="/register"> <button class="btn btn-xl btn-outline-light btn-success btn-block">
          Join Today
        </button></router-link>
      </div>
    </div>
    <!---------------------------------Bottom Part of Welcome------------------------------------>
