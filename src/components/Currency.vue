...
export default {
    ...
    methods: {
        ...
        fetchValues(page_url) {
            let vm = this;
            page_url = page_url || axios.defaults.baseURL + "/api/currency";
            fetch(page_url) //calling the api url for packages data
                .then(res => res.json())
                .then(res => {
                    this.currencies = res.data; //sending data to plans array
        ...
        deleteValue(id) {
            Swal.fire({
                ...
                if (result.value) {
                    fetch(axios.defaults.baseURL + "/api/currency/" + id, {
                        method: "delete"
                    })
                        .then(res => res.json())
                        .then(data => {
